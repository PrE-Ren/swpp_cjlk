...
export const LoginAuthPage = ({ username, password, mySNU_verification_token, phone_token,
  ...
  const emailform = <Grid.Column style={{ maxWidth: 450 }}>
  ...
  const emailfin = <Grid.Column style={{ maxWidth: 450 }}>
    <Header as='h2' color='teal' textAlign='center'>
      Authenticate your MySNU email
    </Header>
    <Form size='large'>
  ...
  const phoneform = <Grid.Column style={{ maxWidth: 450 }}>
    <Header as='h2' color='teal' textAlign='center'>
  ...
  const phonefin = <Grid.Column style={{ maxWidth: 450 }}>
    <Header as='h2' color='teal' textAlign='center'>
      Authenticate your phone
    </Header>
    <Form size='large'>
