...
import { Button, Comment, Form, Modal, Grid } from 'semantic-ui-react'
        ...
        <Grid columns={2}>
          ...
          <Grid.Column width={15}>
            <Comment.Content>
              ...
              {/* 댓글 내용 */}
              <Comment.Text><pre style={{marginTop:'-5px',fontFamily:'Georgia',whiteSpace:'pre-wrap'}}>{comment_info.content}</pre></Comment.Text>
            </Comment.Content>
          </Grid.Column>
        </Grid>
      </span>
