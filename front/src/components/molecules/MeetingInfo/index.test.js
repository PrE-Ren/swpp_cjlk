...
const meeting7 = {id: 4, title: '미팅', created: '2019-05-10T19:00:00+09:00', leader: 'def', min_people: 2, max_people: 4, state: 4, description: '미팅 구해요', kind: 5, due: '2019-05-16T19:00:00+09:00', picture: null, members: [1,2,7]}


it('renders page when leader access', () => {
  const wrapper = wrap({ state: state1, meeting_info : meeting, change_meeting_state_click: onClick, join_meeting_click: onClick2, withdraw_meeting_click: onClick3, change_meeting_info_click: onClick4, load_leaderinfo_click: onClick5})
  ...
  const wrapper2 = wrap({ state: state1, meeting_info : meeting2, change_meeting_state_click: onClick, join_meeting_click: onClick2, withdraw_meeting_click: onClick3, change_meeting_info_click: onClick4, load_leaderinfo_click: onClick5})
  ...
  const wrapper3 = wrap({ state: state1, meeting_info : meeting3, change_meeting_state_click: onClick, join_meeting_click: onClick2, withdraw_meeting_click: onClick3, change_meeting_info_click: onClick4, load_leaderinfo_click: onClick5})
  ...
  const wrapper4 = wrap({ state: state1, meeting_info : meeting4, change_meeting_state_click: onClick, join_meeting_click: onClick2, withdraw_meeting_click: onClick3, change_meeting_info_click: onClick4, load_leaderinfo_click: onClick5})
  ...
  const wrapper5 = wrap({ state: state1, meeting_info : meeting5, change_meeting_state_click: onClick, join_meeting_click: onClick2, withdraw_meeting_click: onClick3, change_meeting_info_click: onClick4, load_leaderinfo_click: onClick5})
...
it('renders page when others access', () => {
  const wrapper = wrap({ state: state1, meeting_info : meeting7, change_meeting_state_click: onClick, join_meeting_click: onClick2, withdraw_meeting_click: onClick3, change_meeting_info_click: onClick4, load_leaderinfo_click: onClick5})
  ...
  const wrapper2 = wrap({ state: state1, meeting_info : meeting6, change_meeting_state_click: onClick, join_meeting_click: onClick2, withdraw_meeting_click: onClick3, change_meeting_info_click: onClick4, load_leaderinfo_click: onClick5})
  ...
  const wrapper3 = wrap({ state: state2, meeting_info : meeting6, change_meeting_state_click: onClick, join_meeting_click: onClick2, withdraw_meeting_click: onClick3, change_meeting_info_click: onClick4, load_leaderinfo_click: onClick5})
